window.PortalAdmin = {
    ...
    // Adicione esta função helper no final do objeto PortalAdmin (antes do fechamento)
    escapeHtml(text) {
        if (!text) return '';
        const div = document.createElement('div');
    ...
    // ADICIONADO: Criar novo dicionário
